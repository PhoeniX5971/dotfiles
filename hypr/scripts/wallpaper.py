...
async def run_script(wallpaper):
    script_path = os.path.expanduser(
        "~/.ml4w-hyprland/2.9.7.0/.config/hypr/scripts/wallpaper.sh"
    ...
    if process.returncode != 0:
        ...
        print(f":: Script executed successfully: {stdout.decode()}")
...
async def main():
    ...
    # Run the script after setting the wallpaper
    await run_script(new_wallpaper)
    # -----------------------------------------------------
    # Generate colors
    # -----------------------------------------------------
